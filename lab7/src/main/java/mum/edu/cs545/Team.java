...
public class Team {
	...
	public String toString() {
		return "Team [teamKey=" + teamKey + ", name=" + name + ", city=" + city + ", mascot=" + mascot + ", players="
				+ players + ", homeUniform=" + homeUniform + ", visitUniform=" + visitUniform + ", matchesAsHome="
				+ matchesAsHome + ", matchesAsVisitor=" + matchesAsVisitor + "]";
	}
